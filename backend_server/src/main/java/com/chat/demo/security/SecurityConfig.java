        ...
        http
            .authorizeRequests(authorizeRequests ->
                authorizeRequests
                    ...
                    // for Permiting all requests to test postman ,delete what's up and add this:(remember to comment the preauthorize)
                    //.anyRequest().permitAll()
            )
            // .formLogin(withDefaults());
            .formLogin(formLogin ->
        formLogin
            .loginPage("/login") // Specify the custom login page endpoint
